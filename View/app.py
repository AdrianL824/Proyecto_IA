...
class AppWindow(ctk.CTk, tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.main_frame = ctk.CTkFrame(self, width=1000, height=200)  # Crea un marco principal con las dimensiones 1200x650
        self.main_frame.columnconfigure(0, weight=1)
        self.main_frame.rowconfigure(0, weight=1)
        self.main_frame.rowconfigure(1, weight=1)

        self.options_frame = ctk.CTkFrame(self.main_frame, width=1000, height=800)  # Crea un marco de opciones con las dimensiones 1000x100
        ...
        self.entry_start = ctk.CTkEntry(self.options_frame, placeholder_text="Ingrese el inicio")  # Crea una entrada de texto con un texto de marcador "Ingrese el inicio"
        ...
        self.entry_destination = ctk.CTkEntry(self.options_frame, placeholder_text="Ingrese el destino")  # Crea una entrada de texto con un texto de marcador "Ingrese el destino"
        ...
        self.img_frame = ctk.CTkCanvas(self.main_frame, width=1000, height=630, bg="#0E6063")  # Crea un lienzo con las dimensiones 1200x550 y un color de fondo "#0E6063"
        self.img_frame.grid(row=1, column=0, columnspan=6, sticky=tk.NSEW, padx=10, pady=10)  # Ubica el lienzo en la segunda fila y columna del marco principal
